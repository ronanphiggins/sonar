...
import de.andreasschrade.androidtemplate.ui.quote.LoginActivity;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        /*Glide.with(this).load("https://api.backendless.com/A0819152-C875-C222-FF18-0516AB9ACC00/v1/files/media/ECC5B9F0.jpg").asBitmap().fitCenter().into(new BitmapImageViewTarget(img) {
            @Override
    ...
    private void setupNavDrawer() {
        ...
        String finalurl = "https://api.backendless.com/A0819152-C875-C222-FF18-0516AB9ACC00/v1/files/media/" + part + ".jpg";
    ...
    private void goToNavDrawerItem(int item) {
        switch (item) {
            ...
            case R.id.nav_logout:
                ...
                pDialog.setMessage("Signing off...");
