...
public class ArticleListFragment extends ListFragment {
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            Glide.with(getActivity()).load("https://api.backendless.com/A0819152-C875-C222-FF18-0516AB9ACC00/v1/files/media/F357AC7A640.jpg").asBitmap().fitCenter().into(new BitmapImageViewTarget(img) {
                @Override
